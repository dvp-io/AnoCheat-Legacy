  ...
  function onchange (evt) {
    ...
    if (!(evt.type in evtMap))
        if (!$("#conversation0").children().last().is("fieldset"))
            ...
            this[hidden] ? $("#conversation0").append('<fieldset style="border-top: 1px dashed #0074cd; border-bottom: none; border-left: none; border-right: none; display: block; text-align: center;"><legend align="center" style="padding: 0px 10px; font-size:8pt; color:#0074cd;">' + time +'</legend></fieldset>') : '';
  }
